...
export default function RowSlide({ novelId, categoryId, categoryText, novelNO, children }: Props) {
  ...
  return (
    <RowBG>
      <CategoryMark novelId={novelId} categoryId={categoryId} categoryText={categoryText} />
      <RowSlideContainer>
