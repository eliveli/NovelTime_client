...
export const NAVER_AUTH_URL = `https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=${REST_API_KEY_NAVER}&state=${}&redirect_uri=${REDIRECT_URI_NAVER}`;
